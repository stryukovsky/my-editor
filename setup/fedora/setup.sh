...
dnf install libubsan libasan lcov fzf zsh neovim  golang zlib-devel ripgrep gcc-c++ bpytop make gcc patch zlib-devel bzip2 bzip2-devel readline-devel sqlite sqlite-devel openssl-devel tk-devel libffi-devel xz-devel libuuid-devel gdbm-libs libnsl2 wireguard-tools postgresql-server postgresql-contrib alacritty tmux  wl-clipboard sassc gtk-murrine-engine gnome-themes-extra  gnome-extensions-app fd-find lazygit libpq-devel uchardet-devel glide -y
